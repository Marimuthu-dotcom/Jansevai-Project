...
const handleLogin = async (e) => {
  ...
  try {
    ...
    setSuccess(true);
    setTimeout(() => {
      loginClose(token); // ✅ login() இல்ல — loginClose() use பண்ணு
      login(token);      // ✅ AuthContext update
    }, 2000);
  } catch (err) {
    // ...
  }
...
// handleGoogleSignUp fix — login() remove பண்றோம்
...
// handleSubmit — register பண்ணும்போது login() call வேண்டாம்!
