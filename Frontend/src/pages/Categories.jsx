  ...
  const STATS = [
    {
      ...
      change: null,
      trend: null,
      icons:<LayoutGrid color="rgb(66, 46, 244)"/>,
      bg_color: "rgba(25, 0, 255, 0.10)"
    },
    {
      ...
      icons:<FileWarning color="rgb(250, 133, 8)"/>,
      bg_color: "rgba(250, 133, 8, 0.10)"
    },
    {
      label: "Most Active",
      value: mostActive,
      change: null,
      trend: null,
      icons:<Activity color="rgb(245, 35, 35)"/>,
      bg_color: "rgba(246, 10, 10, 0.10)"
    },
    {
      label: "Resolved Rate",
      value: `${resolvedRate}%`,
      ...
      trend: resolvedTrend,
      icons:<BadgeCheck color="rgb(15, 251, 23)"/>,
      bg_color: "rgba(15, 251, 23, 0.10)"
    },
  ];
    ...
    <div className={`${styles1.categoriesContainer} ${styles.mainContainer}`}>
      ...
      <div className={styles.statsRow}>
        {STATS.map((s, i) => (
          ...
          >
            <div className={styles.statIcon} style={{ backgroundColor: s.bg_color}}>
              {s.icons}
            </div>
